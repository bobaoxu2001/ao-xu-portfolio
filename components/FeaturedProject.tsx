  ...
  return (
    <section className="py-20">
      <div className="container-xl">
        ...
        <div className="overflow-hidden rounded-2xl border border-white/10 bg-white/[0.035] backdrop-blur-sm shadow-[0_24px_60px_-16px_rgba(8,18,48,0.8)]">
          ...
          <div className="grid lg:grid-cols-[1.35fr_0.9fr]">
            <div className="p-7 sm:p-9">
              <span className="mb-4 inline-flex rounded-full border border-blue-400/20 bg-blue-500/10 px-3 py-1 text-xs font-bold text-blue-200">
                {p.badge}
              </span>
              ...
              <p className="mb-7 max-w-2xl text-[15px] leading-relaxed text-slate-300">
                {p.description}
              </p>
              ...
              <div className="grid gap-4 sm:grid-cols-3 mb-7">
                {[
                  ...
                  <div key={label} className="rounded-xl border border-white/10 bg-white/[0.04] p-4">
                    <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.14em] text-blue-300">
                      {label}
                    </p>
            ...
            <div className="border-t border-white/10 bg-gradient-to-br from-blue-950/40 to-slate-900/40 p-7 sm:p-9 lg:border-l lg:border-t-0">
          ...
          <div className="border-t border-white/10 bg-white/[0.02] px-7 py-7 sm:px-9">
            ...
            <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:gap-0">
              {PIPELINE.map((step, i) => (
                <div key={step.label} className="flex flex-col sm:flex-1 sm:flex-row sm:items-center">
                  <div className="flex-1 rounded-xl border border-white/10 bg-white/[0.04] p-4 text-center sm:text-left">
                    <span className="mb-2 inline-flex h-9 w-9 items-center justify-center rounded-lg bg-blue-500/10 text-blue-300 ring-1 ring-blue-400/20">
                      <step.icon size={18} strokeWidth={2} />
                    </span>
                    <p className="text-[13px] font-bold leading-snug text-white">{step.label}</p>
                    <p className="mt-0.5 text-[11px] text-slate-400">{step.sub}</p>
                  </div>
                  {i < PIPELINE.length - 1 && (
                    <div className="flex items-center justify-center text-slate-600 sm:px-1.5">
            ...
            <div className="mt-3 flex items-center gap-2 rounded-xl border border-dashed border-white/15 bg-white/[0.02] px-4 py-2.5">
